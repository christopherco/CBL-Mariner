...
Note: The ISO is intended for testing in virtual environments. Because it is intended for use in Azure, it contains intentionally limited hardware support.
